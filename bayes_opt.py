...
def objective(trial):
    ...
    cfg.CONTINUE_FROM_INIT_WEIGHTS = False     # True: 續訓；False: 從頭
    cfg.INIT_CHECKPOINT_DIR = "./model_A"
    #── 搜參 ──
    cfg.LEARNING_RATE   = trial.suggest_float("lr", 1e-8, 1e-4, log=True)
    ...
    warm_ratio = trial.suggest_float("warmup_ratio", 0.02, 0.06)
